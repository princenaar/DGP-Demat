...
class DemandeWorkflowTest extends TestCase
{
    ...
    public function test_non_engagement_pdf_uses_short_title(): void
    {
        ...
        $this->assertStringContainsString('M./Mme&nbsp;Awa&nbsp;DIOP</strong></span>, <span class="nowrap">né(e) le&nbsp;12 mai 1990</span> à Dakar Plateau, <span class="nowrap">CNI n°&nbsp;<strong>1234567890123</strong></span>,', $html);
