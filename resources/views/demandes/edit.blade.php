...
@php
    ...
    $dateNaissance = old('date_naissance', optional($demande->date_naissance)->format('Y-m-d'));
            ...
            <div class="bg-white rounded-lg shadow border border-gray-100 p-6 sm:p-8">
                ...
                <form method="POST" action="{{ $formAction }}" enctype="multipart/form-data" class="mt-6"
                      x-data="{
                          ...
                          init() {
                              if (this.eligibility) {
                                  this.statut = this.eligibility;
                              }
                          },
                          isAne() {
                              return this.typeCode === 'ANE';
                          },
                          hasFixedEligibility() {
                              return Boolean(this.eligibility);
                          },
                    ...
                    <section class="space-y-5">
                        ...
                        <div class="grid grid-cols-1 gap-5 sm:grid-cols-3">
                            <div x-show="visible('date_naissance')" x-cloak>
                                ...
                                <x-text-input type="date" name="date_naissance" id="date_naissance" class="mt-1 block w-full" x-bind:class="fieldClass('date_naissance')" :value="$dateNaissance" x-on:input="clearFieldState('date_naissance')" x-on:blur="validateField('date_naissance', $event.target)" x-bind:required="required('date_naissance')" />
                            ...
                            <div x-show="visible('lieu_naissance')" x-cloak>
                                ...
                                <x-text-input type="text" name="lieu_naissance" id="lieu_naissance" class="mt-1 block w-full" x-bind:class="fieldClass('lieu_naissance')" :value="old('lieu_naissance', $demande->lieu_naissance)" x-on:input="clearFieldState('lieu_naissance')" x-on:blur="validateField('lieu_naissance', $event.target)" x-bind:required="required('lieu_naissance')" />
